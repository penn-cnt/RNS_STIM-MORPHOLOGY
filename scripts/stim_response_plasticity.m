...
disp(['There are ' num2str(sum(use_stims1)) '/' num2str(length(stim_idxs)) ' stimulations in scheduled events']);
...
event_times = sort(convertTo(table2array(event_id_table(:,'RawLocalTimestamp')),'posixtime'));
session_times = convertTo(table2array(session_id_table),'posixtime');
